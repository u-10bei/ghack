defmodule GhackWeb.LocationControllerTest do
  use GhackWeb.ConnCase

  alias Ghack.AED

  @create_attrs %{latitude: 120.5, locationName: "some locationName", longitude: 120.5}
  ...
  def fixture(:location) do
    {:ok, location} = AED.create_location(@create_attrs)
    location
  end
